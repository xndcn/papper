...
export const SCENE_KEYS = {
  ...
  TOURNAMENT_MAP: 'TournamentMapScene',
  BUILD: 'BuildScene',
  RACE: 'RaceScene',
  RESULT: 'ResultScene',
} as const;
...
export const SCENE_TRANSITIONS = {
  ...
  [SCENE_KEYS.MAIN_MENU]: [SCENE_KEYS.TOURNAMENT_MAP],
  [SCENE_KEYS.TOURNAMENT_MAP]: [SCENE_KEYS.BUILD, SCENE_KEYS.MAIN_MENU],
  [SCENE_KEYS.BUILD]: [SCENE_KEYS.RACE],
  [SCENE_KEYS.RACE]: [SCENE_KEYS.RESULT, SCENE_KEYS.BUILD],
  [SCENE_KEYS.RESULT]: [SCENE_KEYS.TOURNAMENT_MAP, SCENE_KEYS.MAIN_MENU],
} as const;
